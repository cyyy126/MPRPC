...
// repeated .fixbug.User friend_list = 2;
inline int GetFriendListsResonse::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GetFriendListsResonse::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendListsResonse::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GetFriendListsResonse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResonse.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsResonse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResonse.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GetFriendListsResonse::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResonse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResonse.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriendListsResonse::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GetFriendListsResonse::add_friend_list() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResonse.friend_list)
  return _internal_add_friend_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsResonse::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResonse.friend_list)
  return friend_list_;
}
