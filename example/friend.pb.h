...
class GetFriendListsServiceRpc_Stub;

class GetFriendListsServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline GetFriendListsServiceRpc() {};
 public:
  virtual ~GetFriendListsServiceRpc();

  typedef GetFriendListsServiceRpc_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(GetFriendListsServiceRpc);
};

class GetFriendListsServiceRpc_Stub : public GetFriendListsServiceRpc {
 public:
  GetFriendListsServiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  GetFriendListsServiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
                   ::PROTOBUF_NAMESPACE_ID::Service::ChannelOwnership ownership);
  ~GetFriendListsServiceRpc_Stub();

  inline ::PROTOBUF_NAMESPACE_ID::RpcChannel* channel() { return channel_; }

  // implements GetFriendListsServiceRpc ------------------------------------------
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(GetFriendListsServiceRpc_Stub);
};
